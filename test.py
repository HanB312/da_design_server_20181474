...
def test_logger():
    ...
    try:
        m = mylogger.get_logger('test', '/home/ubuntu/da_design_server_20181474/log')
        m.debug('hi, debug')
...
def test_config():
    ...
    try:
        m = myconfig.get_config('/home/ubuntu/da_design_server_20181474/share/test.config')
